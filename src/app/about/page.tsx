        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img
                src="https://storage.googleapis.com/workspace-ai-generated/image-shobha-beauty-studio-founder.jpg"
                alt="Shobha Beauty Studio founder and team in professional salon setting"
                className="rounded-2xl shadow-2xl w-full h-auto object-cover"
                onError={(e) => {
                  const target = e.currentTarget as HTMLImageElement;
                  target.src = "https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/f3db9318-f13e-4755-a1cb-48879bb0ffba.png";
                }}
              />
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-900/50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img
                src="https://storage.googleapis.com/workspace-ai-generated/image-salon-interior-modern.jpg"
                alt="Modern beauty salon interior with elegant styling stations and comfortable waiting area"
                className="rounded-2xl shadow-2xl w-full h-auto object-cover"
                onError={(e) => {
                  const target = e.currentTarget as HTMLImageElement;
                  target.src = "https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/c2829b10-d3eb-4c4d-9afd-bbb658e2200b.png";
                }}
              />
            </div>
          </div>
